...

{
  ...
  nix.settings = {
    ...
    # set caches:
    substituters = [ "https://cache.nixos.org" "https://freesmlauncher.cachix.org" ];
    trusted-public-keys = [ "cache.nixos.org-1:6NCHdD59X431o0gWypbMrAURkbJ16ZPMQFGspcDShjY=" "freesmlauncher.cachix.org-1:Jcp5Q9wiLL+EDv8Mh7c6L9xGk+lXr7/otpKxMOuBuDs=" ];
  };
